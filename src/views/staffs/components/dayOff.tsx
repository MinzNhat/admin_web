...
import { CreateDayOffDto, SearchCriteria, ShipperType, StaffRole } from "@/services/interface";
import { useDefaultNotification } from "@/hooks/DefaultNotificationProvider";
import { DayOffInfo, RoleValue } from "@/types/store/auth-config";
...
const AddDayOff = ({ openAdd, setOpenAdd, staffId }: Props) => {
